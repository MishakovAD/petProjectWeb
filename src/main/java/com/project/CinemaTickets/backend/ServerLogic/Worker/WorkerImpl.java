...
import com.project.CinemaTickets.backend.ServerLogic.HttpBackendClient.PlHttpClient;
...
//        str.substring(0, str.indexOf("/day"));
        ...
        w.setPliHttpClient(new PlHttpClient());
        w.setPliParserKinopoisk(new PlParserKinopoisk());
        w.run();
        //w.initWeekArray();
