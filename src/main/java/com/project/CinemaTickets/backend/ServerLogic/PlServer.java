...
//        System.out.println("End emulation");
        ...
        Document document = new PlProxyServer().getHttpDocumentFromInternet("https://www.kinopoisk.ru/afisha/city/1/cinema/280891/day_view/2019-08-11/");
        Cinema cinema = new PlParserKinopoisk().getCinemaFromDocument(document);
        Document document2 = new PlProxyServer().getHttpDocumentFromInternet("https://www.kinopoisk.ru/afisha/city/1/cinema/281063/day_view/2019-08-11/");
        ...
        cinemaMovieSessionList.forEach(obj -> new HibernateDaoImpl().saveCinemaMovieSessionObj(obj));
