...
import com.project.NeuralNetwork.Base.Networks.NeuralNetwork.NeuralNetwork;
import com.project.NeuralNetwork.Base.Networks.School.ISchool;
import com.project.NeuralNetwork.Base.Networks.School.School;
...
public class Test {
    public static void main(String[] args) throws NotCorrectInitialConditions {
        //new Test().xor();
    ...
    private void xor() throws NotCorrectInitialConditions {
        ...
        NeuralNetwork net2 = NeuralNetwork.newBuilder()
                .setCountInputNeurons(2)
                .setCountHiddenLayers(1)
                .setCountHiddenNeurons(3)
                .setCountOutputNeurons(1)
                .setFunctionType(Functions.SIGMA)
                .build();
